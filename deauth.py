    ...
    def __new__(cls, *args,**kwargs):
        ...
        if not mon_interface:
            ...
            if os.system("airmon-ng start wlan0")!=0:
                print "airmon-ng not found. Please install aircrack-ng. RUN 'sudo apt-get install aircrack-ng -y'"
...
class sniffWifi(object):
    ...
    def __init__(self,pktlimit=2000):
        ...
        self.pktcount=0
        self.ssidcount=0
        self.pktlimit=pktlimit
        self.test=spinning_cursor()
...
if __name__=='__main__':
    try:
        input=os.environ["DEAUTH"] #Starting with Environmental variable
        ...
        if len(sys.argv)==1: # No command line argument
            ...
            sniff=sniffWifi()
            sniff.runSniff()
            print "\n\n","0".ljust(2," "),"Send deauth packets to every network given below"
            while True:
